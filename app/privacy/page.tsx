  ...
  return (
    <main>
      ...
      <section className="flex-col justify-center items-center ">
        <h1 className="flex p-10 font-medium text-xl">Политика обработки персональных данных</h1>
        <h1 className="px-10">
          ...
          https://pechataem35.com. 2. Основные понятия, используемые в Политике
          ...
          адресу https://pechataem35.com. 2.4. Информационная система
          ...
          https://pechataem35.com. 2.9. Персональные данные, разрешенные
          ...
          https://pechataem35.com. 2.11. Предоставление персональных данных —
          ...
          почты 7. Условия обработки персональных данных 7.1. Обработка
          персональных данных осуществляется с согласия субъекта персональных
          данных на обработку его персональных данных. 7.2. Обработка
          ...
          почты privacy@thismywebsite.com. 12.2. В данном документе будут
          ...
          сети Интернет по адресу https://thismywebsite.com/privacy/.
        </h1>
      </section>
      <Footer></Footer>
    </main>
