  ...
  return (
    <main>
      ...
      <section className="flex-col justify-center items-center ">
        <h1 className="flex p-10 font-medium text-xl">
        ...
        <div className="text-justify px-10">
          ...
          <p>
            ...
            <ul>
              ...
              <li>
                ...
                материалам, содержащимся на веб-сайте https://pechataem35.com.
              </li>
            </ul>
          </p>
          <p>
            ...
            электронной почты info@pechataem35.com с пометкой «Отказ от
          ...
          <p>
            ...
            https://pechataem35.com или направленные Оператору посредством
          ...
          <p>
            ...
            Оператора info@pechataem35.com с пометкой «Актуализация персональных
            данных».
          </p>
          <p>
            10.4. Срок обработки персональных данных является неограниченным.
            ...
            info@pechataem35.com с пометкой «Отзыв согласия на обработку
            персональных данных».
          </p>
          ...
          <p>
            ...
            к Оператору с помощью электронной почты info@pechataem35.com.
          </p>
          <p>
          ...
          <p>
            ...
            сети Интернет по адресу https://pechataem35.com/privacy.
          </p>
        </div>
      </section>
      <Footer></Footer>
